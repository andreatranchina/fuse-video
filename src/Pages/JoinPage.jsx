    ...
    const joinRoom = async () => {
        ...
        try{
            if(choseType === "Livestream"){
              ...
              const response = await axios.get(`https://video-backend-6mkl.onrender.com/api/livestreams/byCode/${code}`);
              ...
              navigate(`/livestream/${code}`);
                ...
                const response = await axios.get(`https://video-backend-6mkl.onrender.com/api/videochats/byCode/${code}`);
